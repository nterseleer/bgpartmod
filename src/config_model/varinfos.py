...
doutput = {"Phy_C": {'units': 'mmol C m-3',
           ...
           "TEP_Chl_ratio": {'units': 'gTEPC gChla-1',
                             'oprt': 'TEPC_C/Phy_Chl',
                             'cleanname': 'TEP:Chl',
                             'longname': 'TEP C to Chlorophyll ratio'},
           "TEP_PhyC_ratio": {'units': 'gTEPC gPhyC-1',
                              'oprt': 'TEPC_C/Phy_C',
                              'cleanname': 'TEP:Phy_C',
                              'longname': 'TEP C to Phytoplankton C ratio'},
           "Chl_PhyC_ratio": {'units': 'mgChla gPhyC-1',
                              'oprt': 'Phy_Chl/Phy_C',
                              'cleanname': 'Chl:Phy_C',
                              'longname': 'Chlorophyll to Phytoplankton C ratio'},
