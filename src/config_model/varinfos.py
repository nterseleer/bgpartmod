...
doutput = {"Phy_C": {'units': 'mmol C m-3',
        ...
        "Phy_limI_upper_layer": {'units': '-',
                        'munits': '-',
                        'longname': 'Phytoplankton light limitation (photic-layer mean)',
                        'cleanname': 'Phy_{lim_{upper}}^{I}'},

        "Phy_limI_theoretical": {'units': '-',
                        'munits': '-',
                        'longname': 'Phytoplankton light limitation (depth-diluted, no enrichment)',
                        'cleanname': 'Phy_{lim_{theoretical}}^{I}'},

        "Phy_limI_vs_limI_upper_layer_ratio": {'units': '-',
                        'munits': '-',
                        'oprt': 'Phy_limI / Phy_limI_upper_layer',
                         'longname': 'limI : limI_{upper}',
                        'cleanname': 'Phy_{lim}^{I} : Phy_{lim_{upper}}^{I}'},
           "Phy_limI_vs_limI_theoretical_ratio": {'units': '-',
                        'munits': '-',
                        'oprt': 'Phy_limI / Phy_limI_theoretical',
           ...
           "Phy_I_H": {'units': 'µE m-2 d^{-1}',
                                      'munits': 'µE m-2 d^{-1}',
                                      'longname': 'Irradiance reaching the seabed',
                                      'cleanname': 'I_H'},
        "Phy_I_H_ratio": {'units': '-',
                        'oprt': 'Phy_I_H/Phy_PAR_t',
                                      'longname': 'I_H:PAR_{incident}',
                                      'cleanname': 'I_H:PAR_0'},
            "Phy_z_upper_layer": {'units': 'm',
                                      'munits': 'm',
                                      'longname': 'z_{upper}',
           ...
           "Phy_source_PP.C": {'units': 'mmolC m^{-3} d^{-1}',
                               ...
                               'longname': 'Gross Primary Production (C_{source})',
                               'cleanname': 'PP'},
